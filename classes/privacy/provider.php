...
class provider implements
    ...
    public static function delete_submission_for_context(assign_plugin_request_data $requestdata) {
        ...
        $fs = get_file_storage();
        $fs->delete_area_files($requestdata->get_context()->id, 'assignsubmission_external_server', ASSIGNSUBMISSION_FILE_FILEAREA);

        // Delete records from assignsubmission_external_server table.
        $DB->delete_records('assignsubmission_external_server', ['assignment' => $requestdata->get_assign()->get_instance()->id]);
    }
    ...
    public static function delete_submission_for_userid(assign_plugin_request_data $deletedata) {
        ...
        $fs = get_file_storage();
        $fs->delete_area_files($deletedata->get_context()->id, 'assignsubmission_external_server', ASSIGNSUBMISSION_FILE_FILEAREA,
                $submissionid);

        $DB->delete_records('assignsubmission_external_server', ['assignment' => $deletedata->get_assignid(), 'submission' => $submissionid]);
    }
    ...
    public static function delete_submissions(assign_plugin_request_data $deletedata) {
        ...
        $fs->delete_area_files_select($deletedata->get_context()->id, 'assignsubmission_external_server', ASSIGNSUBMISSION_FILE_FILEAREA,
                $sql, $params);

        $params['assignid'] = $deletedata->get_assignid();
        $DB->delete_records_select('assignsubmission_external_server', "assignment = :assignid AND submission $sql", $params);
    }
}
